...
import (
	...
	extChat "github.com/ujangpudin04/unika/protogen/go/chat"
...
func request_ChatService_Chat_0(ctx context.Context, marshaler runtime.Marshaler, client extChat.ChatServiceClient, req *http.Request, pathParams map[string]string) (extChat.ChatService_ChatClient, runtime.ServerMetadata, error) {
	...
	handleSend := func() error {
		var protoReq extChat.ChatMessage
...
func RegisterChatServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extChat.ChatServiceServer) error {
...
func RegisterChatServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterChatServiceHandlerClient(ctx, mux, extChat.NewChatServiceClient(conn))
}

// RegisterChatServiceHandlerClient registers the http handlers for service ChatService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extChat.ChatServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extChat.ChatServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extChat.ChatServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterChatServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extChat.ChatServiceClient) error {
	...
	mux.Handle("POST", pattern_ChatService_Chat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chat.ChatService/Chat", runtime.WithHTTPPathPattern("/chat.ChatService/Chat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ChatService_Chat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"chat.ChatService", "Chat"}, ""))
)
